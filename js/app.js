...
function rebuildLayerUI() {
  ...
  for (const layer of layers) {
    ...
    // Layout: visibility | color | name | opacity | blend | delete
    // Per-layer zoom slider removed — global zoom (mouse wheel + Reset View)
    // covers it without crowding the layer row.
